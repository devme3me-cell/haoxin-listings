        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-24 items-center">
          ...
          <div className="relative">
            <div className="image-reveal">
              <img alt="禮儀服務" className="w-full aspect-[4/5] object-cover rounded-lg" src="/lovable-uploads/31143c30-e9b7-4a65-a841-99cc56880fbb.jpg" />
            </div>
          ...
          <div className="lg:pl-12">
            ...
            <ul className="space-y-4 mb-12">
              {["專業禮儀師全程服務", "代銷塔位、生前契約諮詢", "生基、造生基、生基承租", "中式、西式、主題式禮儀"].map(item => <li key={item} className="flex items-center gap-3">

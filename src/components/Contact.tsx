...
const TransactionCard = ({ location, name, action, product, mask, time }: TransactionCardProps) => {
  ...
  return (
    <div className="w-full p-4 md:p-6 bg-white/[0.03] backdrop-blur-[20px] border border-white/[0.08] rounded-2xl relative overflow-hidden pointer-events-none select-none">
      <div className="absolute top-0 left-[-100%] w-full h-full bg-gradient-to-r from-transparent via-white/5 to-transparent" />

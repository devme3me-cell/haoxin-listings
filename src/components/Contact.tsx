    ...
    <section id="contact" className="py-24 lg:py-32 bg-primary text-primary-foreground">
      <div className="container px-6 lg:px-12">
        <div className="grid lg:grid-cols-2 gap-16 lg:gap-24">
          ...
          {/* Form */}
          <div className="bg-background text-foreground p-8 lg:p-12">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-primary text-primary-foreground py-4 text-sm tracking-wider hover:bg-primary/90 transition-colors flex items-center justify-center gap-3 group"
              >
                送出諮詢

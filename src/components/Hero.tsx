  ...
  return <section id="home" className="relative min-h-screen flex items-center">
      ...
      <div className="container relative z-10 px-6 lg:px-12 pt-24">
        <div className="max-w-2xl">
          ...
          <h1 className="text-4xl md:text-5xl font-heading leading-tight mb-8 animate-slide-up lg:text-6xl font-semibold">
            壕芯實業
          </h1>
          ...
          <p className="text-lg md:text-xl text-muted-foreground mb-12 max-w-xl animate-slide-up leading-relaxed" style={{
          animationDelay: "0.3s"
        }}>
          ...
          animationDelay: "0.4s"
            ...
            <a href="#contact" className="inline-flex items-center justify-center gap-3 border border-primary text-primary px-8 py-4 text-sm tracking-wider hover:bg-primary hover:text-primary-foreground transition-all duration-300">
              立即諮詢
            </a>
          </div>
        </div>

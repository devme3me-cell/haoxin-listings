        ...
        <div className="container mx-auto px-6 lg:px-12">
          <div className="max-w-4xl mx-auto space-y-24">
            ...
            >
              ...
              >
                <span className="text-primary">壕芯初衷</span>
        ...
        <div className="container mx-auto px-6 lg:px-12">
          ...
          >
            ...
            >
              <Link
                to="/#services"
                className="px-8 py-4 bg-primary text-primary-foreground tracking-wider hover:bg-primary/90 transition-all duration-300"
              >
                瀏覽服務項目
              </Link>
              <Link
                to="/#contact"
                className="px-8 py-4 border border-foreground text-foreground tracking-wider hover:bg-foreground hover:text-background transition-all duration-300"
              >
                立即諮詢
              </Link>
            </motion.div>
